<?php
    ...
    $trainings = $trainingcontroller->get_alltrainings();
...
if( isset($_POST["delete"]) )
{
    ...
    {
        if($trainingcontroller->delete_training($_POST["trainingId"]))
        {
            $deletemsg = true;
        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <?php
                        foreach($trainings as $trainings) //the problem
                        {
                           ?>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <form action="all-trainings.php" method="POST">
                                        <input name="courseId" type="hidden" value=" <?php echo $course["id"]?> ">
